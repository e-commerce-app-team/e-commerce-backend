...
class WholesaleRegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'commercial_registration_number' => [
                'required',
                'string',             // نبقيها string لضمان التوافق مع قاعدة البيانات
                'digits:5',           // يجب أن يتكون من 5 أرقام بالضبط
                'unique:users,commercial_registration_number' // التأكد من عدم تكراره
            ],
    ...
    /**
     * Define custom error messages for the defined validation rules.
     */
