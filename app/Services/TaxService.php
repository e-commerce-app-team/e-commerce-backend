...
class TaxService
{
     ...
     */
    public function getCommissionRate(string $sellerRole): float
    {
        return $sellerRole === 'wholesale'
            ? PlatformSetting::wholesaleCommissionRate()
            : PlatformSetting::vendorCommissionRate();
    }
     ...
     */
    public function calculateCommission(float $amount, string $sellerRole): array
    {
        $rate       = $this->getCommissionRate($sellerRole);
